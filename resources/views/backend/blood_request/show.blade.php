...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Detail Data Permintaan Darah</h1>
</div>
<div class="col-lg-8">
    {{-- <form action="{{ route('data-permintaan-darah.update', $bloods->id) }}" method="post"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('hospital') is-invalid @enderror" id="hospital"
                ...
                placeholder="Masukkan nama rumah sakit" readonly>
            @error('hospital')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name_request') is-invalid @enderror" id="name_request"
                ...
                placeholder="Masukkan nama pemohon permintaan darah" readonly>
            @error('name_request')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('call_officer') is-invalid @enderror" id="call_officer"
                ...
                placeholder="Masukkan nomor telepon pemohon permintaan darah" readonly>
            @error('call_officer')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name_officer') is-invalid @enderror" id="name_officer"
                ...
                placeholder="Masukkan nama petugas" readonly>
            @error('name_officer')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('sum') is-invalid @enderror" id="sum" name="sum"
                value="{{ old('sum', $bloods->sum) }}" required placeholder="Masukkan jumlah permintaan darah" readonly>
            @error('sum')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
            ...
            <div class="col-lg-3 text-center">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('blooda1') is-invalid @enderror" id="blooda1"
                        ...
                        placeholder="Masukkan jumlah permintaan darah" readonly>
                    @error('blooda1')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <a href="/data-permintaan-darah" class="btn btn-danger"><i class="bi bi-arrow-left"></i> Back</a>
