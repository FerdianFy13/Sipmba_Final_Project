...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambahkan Data Permintaan Darah</h1>
</div>
<div class="col-lg-8">
    <form action="/data-permintaan-darah" method="post" enctype="multipart/form-data" class="mb-5">
        @csrf
        <div class="">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('hospital') is-invalid @enderror" id="hospital"
                name="hospital" value="{{ old('hospital') }}" required placeholder="Masukkan nama rumah sakit">
            @error('hospital')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name_request') is-invalid @enderror" id="name_request"
                name="name_request" value="{{ old('name_request') }}" required
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('call_officer') is-invalid @enderror" id="call_officer"
                name="call_officer" value="{{ old('call_officer') }}" required
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name_officer') is-invalid @enderror" id="name_officer"
                name="name_officer" value="{{ old('name_officer') }}" required placeholder="Masukkan nama petugas">
            @error('name_officer')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('date') is-invalid @enderror" id="date" name="date"
                value="{{ old('date') }}" required placeholder="Masukkan tanggal permintaan darah">
            @error('date')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('time') is-invalid @enderror" id="time" name="time"
                value="{{ old('time') }}" required placeholder="Masukkan waktu permintaan darah">
            @error('time')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('sum') is-invalid @enderror" id="sum" name="sum"
                value="{{ old('sum') }}" required placeholder="Masukkan jumlah permintaan darah">
            @error('sum')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
            ...
            <div class="col-lg-3 text-center">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('blooda1') is-invalid @enderror" id="blooda1"
                        name="blooda1" value="{{ old('blooda1') }}" required
            ...
            <div class="col-lg-3 text-center">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('blooda2') is-invalid @enderror" id="blooda2"
                        name="blooda2" value="{{ old('blooda2') }}" required
                        placeholder="Masukkan jumlah permintaan darah">
                    @error('blooda2')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="col-lg-3 text-center">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('bloodb1') is-invalid @enderror" id="bloodb1"
                        name="bloodb1" value="{{ old('bloodb1') }}" required
                        placeholder="Masukkan jumlah permintaan darah">
                    @error('bloodb1')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="col-lg-3 text-center">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('bloodb2') is-invalid @enderror" id="bloodb2"
                        name="bloodb2" value="{{ old('bloodb2') }}" required
                        placeholder="Masukkan jumlah permintaan darah">
                    @error('bloodb2')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="col-lg-3 text-center">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('bloodc1') is-invalid @enderror" id="bloodc1"
                        name="bloodc1" value="{{ old('bloodc1') }}" required
                        placeholder="Masukkan jumlah permintaan darah">
                    @error('bloodc1')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="col-lg-3 text-center">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('bloodc2') is-invalid @enderror" id="bloodc2"
                        name="bloodc2" value="{{ old('bloodc2') }}" required
                        placeholder="Masukkan jumlah permintaan darah">
                    @error('bloodc2')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="col-lg-3 text-center">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('bloodd1') is-invalid @enderror" id="bloodd1"
                        name="bloodd1" value="{{ old('bloodd1') }}" required
                        placeholder="Masukkan jumlah permintaan darah">
                    @error('bloodd1')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="col-lg-3 text-center">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('bloodd2') is-invalid @enderror" id="bloodd2"
                        name="bloodd2" value="{{ old('bloodd2') }}" required
                        placeholder="Masukkan jumlah permintaan darah">
                    @error('bloodd2')
                    <div class="invalid-feedback">
                        {{ $message }}
