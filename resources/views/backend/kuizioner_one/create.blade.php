...
<div class="col-lg-10">
    <form action="/one-kuisioner" method="post" enctype="multipart/form-data" class="mb-5">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer4') is-invalid @enderror" id="answer4" name="answer4"
                value="{{ old('answer4') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer4')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer5') is-invalid @enderror" id="answer5" name="answer5"
                value="{{ old('answer5') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer5')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer7') is-invalid @enderror" id="answer7" name="answer7"
                value="{{ old('answer7') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer7')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer8') is-invalid @enderror" id="answer8" name="answer8"
                value="{{ old('answer8') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer8')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer9') is-invalid @enderror" id="answer9" name="answer9"
                value="{{ old('answer9') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer9')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer10') is-invalid @enderror" id="answer10"
                name="answer10" value="{{ old('answer10') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer10')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer11') is-invalid @enderror" id="answer11"
                name="answer11" value="{{ old('answer11') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer11')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer12') is-invalid @enderror" id="answer12"
                name="answer12" value="{{ old('answer12') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer12')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer13') is-invalid @enderror" id="answer13"
                name="answer13" value="{{ old('answer13') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer13')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer14') is-invalid @enderror" id="answer14"
                name="answer14" value="{{ old('answer14') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer14')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer15') is-invalid @enderror" id="answer15"
                name="answer15" value="{{ old('answer15') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer15')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer16') is-invalid @enderror" id="answer16"
                name="answer16" value="{{ old('answer16') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer16')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer17') is-invalid @enderror" id="answer17"
                name="answer17" value="{{ old('answer17') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer17')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer18') is-invalid @enderror" id="answer18"
                name="answer18" value="{{ old('answer18') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer18')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer19') is-invalid @enderror" id="answer19"
                name="answer19" value="{{ old('answer19') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer19')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer20') is-invalid @enderror" id="answer20"
                name="answer20" value="{{ old('answer20') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer20')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer21') is-invalid @enderror" id="answer21"
                name="answer21" value="{{ old('answer21') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer21')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer22') is-invalid @enderror" id="answer22"
                name="answer22" value="{{ old('answer22') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer22')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer23') is-invalid @enderror" id="answer23"
                name="answer23" value="{{ old('answer23') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer23')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer24') is-invalid @enderror" id="answer24"
                name="answer24" value="{{ old('answer24') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer24')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer25') is-invalid @enderror" id="answer25"
                name="answer25" value="{{ old('answer25') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer25')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer26') is-invalid @enderror" id="answer26"
                name="answer26" value="{{ old('answer26') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer26')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer27') is-invalid @enderror" id="answer27"
                name="answer27" value="{{ old('answer27') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer27')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer28') is-invalid @enderror" id="answer28"
                name="answer28" value="{{ old('answer28') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer28')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer29') is-invalid @enderror" id="answer29"
                name="answer29" value="{{ old('answer29') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer29')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer30') is-invalid @enderror" id="answer30"
                name="answer30" value="{{ old('answer30') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer30')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer31') is-invalid @enderror" id="answer31"
                name="answer31" value="{{ old('answer31') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer31')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer32') is-invalid @enderror" id="answer32"
                name="answer32" value="{{ old('answer32') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer32')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer33') is-invalid @enderror" id="answer33"
                name="answer33" value="{{ old('answer33') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer33')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer34') is-invalid @enderror" id="answer34"
                name="answer34" value="{{ old('answer34') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer34')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer35') is-invalid @enderror" id="answer35"
                name="answer35" value="{{ old('answer35') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer35')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer36') is-invalid @enderror" id="answer36"
                name="answer36" value="{{ old('answer36') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer36')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer37') is-invalid @enderror" id="answer37"
                name="answer37" value="{{ old('answer37') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer37')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer38') is-invalid @enderror" id="answer38"
                name="answer38" value="{{ old('answer38') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer38')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer39') is-invalid @enderror" id="answer39"
                name="answer39" value="{{ old('answer39') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer39')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer40') is-invalid @enderror" id="answer40"
                name="answer40" value="{{ old('answer40') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer40')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('answer41') is-invalid @enderror" id="answer41"
                name="answer41" value="{{ old('answer41') }}" required placeholder="Masukkan jawaban Iya atau Tidak">
            @error('answer41')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
