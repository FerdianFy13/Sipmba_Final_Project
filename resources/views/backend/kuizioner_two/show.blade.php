    ...
    {{-- <form action="/one-kuisioner" method="post" enctype="multipart/form-data" class="mb-5"> --}}
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('user_id') is-invalid @enderror" id="user_id" name="user_id"
                value="{{ old('user_id', $quiz->user->name) }}" placeholder="Masukkan nama pertanyaan" readonly>
            @error('user_id')
        ...
        {{-- @endforeach --}}
        <a href="/two-kuisioner" class="btn btn-danger"><i class="bi bi-arrow-left"></i> Back</a>
