...
<div class="table-responsive col-md-12">
    <a href="/two-kuisioner/create" class="btn btn-warning mb-2">Tambahkan Kuisioner 2</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('two-kuisioner.show', $quiz->id) }}}}" class="badge bg-primary"><i
                            class="bi bi-eye"></i></a>
                    <a href="{{ route('two-kuisioner.edit', $quiz->id) }}" class="badge bg-success"><i
                            class="bi bi-pencil-square"></i></></a>
                    <form action="{{ route('two-kuisioner.destroy', $quiz->id) }}" method="post" class="d-inline">
                        @method('delete')
                        @csrf
