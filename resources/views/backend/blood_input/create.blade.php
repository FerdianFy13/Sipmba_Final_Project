...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambahkan Stok Darah</h1>
</div>
<div class="col-lg-10">
    <form action="/stok-darah" method="post" enctype="multipart/form-data" class="mb-5">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="blood_group_id" required>
                ...
                @if (old('blood_group_id') == $groups->id)
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="blood_component_id" required>
                <option selected>Pilih komponen darah yang sesuai</option>
                @foreach ($component as $components)
                @if (old('blood_component_id') == $components->id)
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('sum') is-invalid @enderror" id="sum" name="sum"
                value="{{ old('sum') }}" required placeholder="Masukkan jumlah darah">
            @error('sum')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
